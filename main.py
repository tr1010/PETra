...
def get_input():
    ...
    verts, surfs, areas, normals, centroids, CoG, I, mass = mesh.Box(1,800,np.array([0.1,0.1,0.1]))
...
#    FPA = 0.54681217*np.pi/180.
#    Head = 99.955734*np.pi/180.
#    vel = 0.#7.58930433867e3 # if this is too low calculation of CpMax fails
#    lat = -79.8489182889*np.pi/180.
#    long = -10*np.pi/180.0
#    alt = 120.0e3
    ...
    e = np.zeros(4)
    e[0] = 1.
    angvel = np.array([0.005,0.005,0.005])
